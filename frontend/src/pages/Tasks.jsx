  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-lg)', animation: 'fade-in 0.4s ease-out' }}>
      ...
      <p className="text-body-lg" style={{ color: 'var(--on-surface-variant)' }}>
        All task assignments across your projects.
      </p>
      ...
      >
        ...
        <p className="text-body-md" style={{ fontWeight: 600 }}>No tasks selected</p>
        <p className="text-label-sm">Select a project from the sidebar to view detailed task boards.</p>
      </div>
    </div>
  );
}
